...
#ifndef HUSARION_UGV_HARDWARE_INTERFACES_HUSARION_UGV_HARDWARE_INTERFACES_ROBOT_SYSTEM_ROBOT_DRIVER_PANTHER_ROBOT_DRIVER_HPP_
#define HUSARION_UGV_HARDWARE_INTERFACES_HUSARION_UGV_HARDWARE_INTERFACES_ROBOT_SYSTEM_ROBOT_DRIVER_PANTHER_ROBOT_DRIVER_HPP_
...
/**
 * @brief This class implements the RoboteqRobotDriver for the Panther robot.
 * It defines two Roboteq drivers (front and rear) with two motors each for controlling the left
 * and right wheels.
 */
class PantherRobotDriver : public RoboteqRobotDriver
{
public:
  PantherRobotDriver(
   ...
   */
  void AttemptErrorFlagReset() override { SendSpeedCommands({0.0, 0.0, 0.0, 0.0}); };
...
#endif  // HUSARION_UGV_HARDWARE_INTERFACES_HUSARION_UGV_HARDWARE_INTERFACES_ROBOT_SYSTEM_ROBOT_DRIVER_PANTHER_ROBOT_DRIVER_HPP_
