...
Name:           ros-jazzy-husarion-ugv-description
Version:        2.3.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS husarion_ugv_description package

License:        Apache License 2.0
URL:            https://husarion.com/
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-husarion-components-description
...
%changelog
* Mon Jun 29 2026 Husarion <support@husarion.com> - 2.3.2-1
- Autogenerated by Bloom

* Thu Aug 14 2025 Husarion <support@husarion.com> - 2.3.1-1
- Autogenerated by Bloom
